...
{
    virtual static object? FactoryKeyName { get; set; }
    /// <summary>
    ...
    /// </returns>
    public static T? GetInstance() => ServiceProviderContainer.Current.GetService<T>();
    /// <summary>
    ...
    /// </exception>
    public static T GetRequiredInstance() => ServiceProviderContainer.Current.GetRequiredService<T>();
    /// <summary>
    ...
    /// </returns>
    public static T GetKeyedInstance(object key) => ServiceProviderContainer.Current.GetKeyedService<T>(key);
    /// <summary>
    ...
    /// </exception>
    public static T GetRequiredKeyedInstance(object key) => ServiceProviderContainer.Current.GetRequiredKeyedService<T>(key);
}
